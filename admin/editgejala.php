<?php
    ...
    include 'koneksi.php';
    $id = $_GET['id_gejala']; 
    $data = mysqli_query($koneksi, "SELECT * FROM tbl_gejala where id_gejala ='$id' ");
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Form Edit Data Gejala</h1>
                <br>

                <form method="POST" action="action/gejalaedit.php">
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Id Gejala</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputEmail3" name="id_gejala" value="<?php echo $d['id_gejala']; ?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputPassword3" class="col-sm-2 col-form-label">Nama Gejala</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputPassword3" name="nama_gejala" value="<?php echo $d['nama_gejala']; ?>">
                    </div>
                    </div>
