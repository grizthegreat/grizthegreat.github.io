    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-1 text-gray-800">Form Tambah Data Aturan</h1>
                <br>
                <form method="POST" action="">
                <input type="hidden" name="id">
                    <div class="row mb-3">
                    <div class="mt-1" >Gejala : </div> <br>
                ...
                <!-- <label class="form-label">Email</label> -->
                    ...
                    <div class="mt-5" >IF YES : </div>
                    <select name="ifyes" class="form-control">
                    ...
                    <?php
                        ...
                        <option value="<?= $d['id_gejala'] ?>"><?= $d['id_gejala'] ?> - <?= $d['nama_gejala'] ?></option>
                    <?php } ?>
                    <option value="0">--- Penyakit ---</option>
                    <?php
                    $data = mysqli_query($koneksi, "SELECT * FROM tbl_penyakit");
                    while($d = mysqli_fetch_array($data)){
                        ?>
                    <option value="<?=$d['id_penyakit']?>"><?=$d['id_penyakit']?> - <?=$d['nama_penyakit']?></option>
                    <?php
                    }
                    ?>
                    </select>
                    <div class="mt-5" >IF NO : </div>
                    <select name="ifno" class="form-control">
                        <option value="">--- PILIH Gejala/Penyakit ---</option>
                    <?php
                        $data = mysqli_query($koneksi, "SELECT * FROM tbl_gejala");
                        while($d = mysqli_fetch_array($data)){
...
if(isset($_POST['simpan'])){
 ...
 $ifyes = $_POST['ifyes'];
 $ifno = $_POST['ifno'];
$simpan = mysqli_query($koneksi, "INSERT INTO tbl_aturan VALUES ('$id','$kode','$ifyes','$ifno')");
if($simpan){
    echo "<script>
           Swal.fire({
             icon: 'success',
