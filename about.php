...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="about.php" style="color: #ffffff;">About</a>
                    </li>
    ...
    <div class="row">
    <div class="col-md-6">
                    <img src="img/mata.png" class="img-fluid rounded" alt="Sistem Pakar">
                </div>
      <div class="col-md-6 align-self-center text-center">
      <h1 class="font-weight-bold">Sistem Pakar Diagnosa Penyakit Mata</h1>
        
        <p>Selamat Datang di Website Kami! Website ini dibuat bertujuan untuk masyarakat melakukan diagnosa penyakit mata dengan gejala awal mata merah</p>
      </div>
    </div>
  </div>
